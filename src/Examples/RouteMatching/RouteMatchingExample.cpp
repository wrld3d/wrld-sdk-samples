...
void RouteMatchingExample::CreateRoutes(bool shouldMatchToNavigationGraph)
{
	...
	std::vector<RouteVertex> fishermansWharfPoints = builder.Start(routeRed, halfWidth, routeSpeedMetersPerSecond, Routes::Road)
	        .AddPoint(37.807173,-122.408929)
	        .AddPoint(37.806982,-122.410527)
	        .ChangeColor(routeGreen)
	        .AddPoint(37.806059,-122.41035)
	        .AddPoint(37.805847,-122.411986)
	        .ChangeColor(routeRed)
	        .AddPoint(37.805385,-122.411916)
	        .AddPoint(37.805177,-122.413537)
	        .ChangeColor(routeBlue)
	        .AddPoint(37.805635,-122.413633)
	        .AddPoint(37.80658,-122.413816)
	        .FinishRoute();
	...
	std::vector<RouteVertex> buenaVistaPoints = builder.Start(routeBlue, halfWidth/2.f, routeSpeedMetersPerSecond, Routes::Road)
	        .AddPoint(37.766088,-122.442888)
	        .AddPoint(37.76597,-122.442698)
	        .AddPoint(37.766037,-122.442576)
	        .AddPoint(37.766129,-122.442381)
	        .AddPoint(37.766171,-122.442263)
	        .AddPoint(37.766307,-122.442053)
	        .AddPoint(37.766667,-122.44175)
	        .AddPoint(37.766945,-122.441635)
	        .AddPoint(37.767274,-122.441549)
	        .AddPoint(37.767683,-122.441276)
	        .FinishRoute();
	...
	std::vector<RouteVertex> islandPoints = builder.Start(routeRed, halfWidth, routeSpeedMetersPerSecond, Routes::Road)
	                                        .AddPoint(37.817416,-122.3681912)
	                                        .AddPoint(37.818747,-122.369023)
	                                        .AddPoint(37.818243,-122.370348)
	                                        .AddPoint(37.820277,-122.3717)
	                                        .AddPoint(37.820768,-122.370456)
	                                        .AddPoint(37.822794,-122.371775)
	                                        .ChangeClassification(Routes::Pedestrian)
	                                        .ChangeColor(routeBlue)
	                                        .AddPoint(37.822887,-122.371207)
	                                        .AddPoint(37.822396,-122.370273)
	                                        .AddPoint(37.824709,-122.370316)
	                                        .FinishRoute();
