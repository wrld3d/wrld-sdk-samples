...
namespace Examples
{
    ...
    void VRCardboardExample::SetVRCameraState(float headTransform[])
    {
    ...
    Eegeo::Camera::CameraState VRCardboardExample::GetCurrentLeftCameraState(float headTransform[]) const
    {
    ...
    Eegeo::Camera::CameraState VRCardboardExample::GetCurrentRightCameraState(float headTransform[]) const
    {
        Eegeo::m33 orientation;
        Eegeo::v3 right = Eegeo::v3(headTransform[0],headTransform[4],headTransform[8]);
        Eegeo::v3 up = Eegeo::v3(headTransform[1],headTransform[5],headTransform[9]);
