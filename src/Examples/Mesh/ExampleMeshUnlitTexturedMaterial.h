...
namespace Examples
{
    class ExampleMeshUnlitTexturedMaterial : public Eegeo::Rendering::Materials::IMaterial, Eegeo::NonCopyable
    {
    public:
        ExampleMeshUnlitTexturedMaterial(const Eegeo::Rendering::TMaterialId materialId,
