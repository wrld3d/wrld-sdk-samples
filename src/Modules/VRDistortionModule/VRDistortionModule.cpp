...
namespace Eegeo
{
    namespace VR
    {
        namespace Distortion
        {
            ...
            {
                Eegeo::VR::Distortion::VRCardboardV1ProfileFactory* vrCardboardV1ProfileFactory =  Eegeo_NEW(Eegeo::VR::Distortion::VRCardboardV1ProfileFactory)();
                m_pCardboardProfile = vrCardboardV1ProfileFactory->GetCardboardDeviceProfile();
                m_pPositionUvVertexLayout = CreatePositionUvVertexLayout();

                m_pTransitionModel = Eegeo_NEW(VRDistortionTransitionModel)();
                Eegeo_DELETE vrCardboardV1ProfileFactory;
            }
